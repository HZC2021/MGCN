...
rad = 0.10
r = 0.50
TrainX = np.load('./data_pos/gcn/dist_%.2f/ext_%.2f/1/train_GCN_X.npy'%(rad, r))
TestX = np.load('./data_pos/gcn/dist_%.2f/1/test_GCN_X.npy'%rad)
TrainY = np.load("./data_pos/gcn/dist_%.2f/ext_%.2f/train_GCN_y.npy" % (rad, r))
TestY = np.load("./data_pos/gcn/dist_%.2f/1/test_GCN_y.npy" % (rad))
